package com.kake.base.pages.search
...
import com.kake.base.components.LoadingIndicator
...
import com.kake.base.util.searchPostsByCategory
import com.kake.base.util.searchPostsByTitle
    ...
    LaunchedEffect(key1 = context.route) {
        ...
        if (hasCategoryParam) {
            searchPostsByCategory(
                category = runCatching { com.kake.base.models.Category.valueOf(value) }
                    .getOrElse { com.kake.base.models.Category.Programming },
                skip = postsToSkip,
                onSuccess = { response ->
                ...
                content = {
                    CategoryNavigationItems(
                        selectedCategory = if (hasCategoryParam) runCatching {
                            com.kake.base.models.Category.valueOf(value)
                        }.getOrElse { com.kake.base.models.Category.Programming } else null,
                        vertical = true
                    )
                }
            )
            ...
            if (hasCategoryParam) {
                SpanText(
                    modifier = Modifier
                        ...
                        .fontSize(36.px),
                    text = value.ifEmpty { com.kake.base.models.Category.Programming.name }
                )
            }
            PostsSection(
                breakpoint = breakpoint,
