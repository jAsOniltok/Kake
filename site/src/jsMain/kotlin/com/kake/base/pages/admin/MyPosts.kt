...
import com.kake.base.components.PostsView
import com.kake.base.components.SearchBar
...
import com.kake.base.util.deleteSelectedPosts
import com.kake.base.util.fetchMyPosts
import com.kake.base.util.isUserLoggedIn
import com.kake.base.util.noBorder
import com.kake.base.util.parseSwitchText
...
fun MyPostsScreen() {
    ...
    LaunchedEffect(context.route) {
        postsToSkip = 0
        if (hasParams) {
            (document.getElementById(Id.adminSearchBar) as HTMLInputElement).value = query.replace(
                "%20",
                " "
            )
            searchPostsByTitle(
